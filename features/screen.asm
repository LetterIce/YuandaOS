...
.esc_pressed:				; Set carry flag if Escape was pressed
	...
	.help_msg1	db 'Pilih file dengan tombol kursor', 0
	.help_msg2	db 'untuk list dibawah...', 0
...
os_list_dialog:
	...
	mov bl, 00011111b   ; White on dark blue
...
os_input_dialog:
	...
	mov dh, 10			; First, draw background box
	mov dl, 12

.box:				; Loop to draw all lines of box
	call os_move_cursor
...
os_dialog_box:
	...
	mov dh, 9			; First, draw background box
	mov dl, 19
...
.two_button_wait:
	...
	mov bl, 00011111b   ; White on dark blue for cancel button
	mov dh, 14
	mov dl, 42
	mov si, 9
	mov di, 15
...
.noleft:
	...
	mov bl, 00011111b   ; White on dark blue (fix)
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15

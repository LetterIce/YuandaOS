	...
	%DEFINE NOS_VER 'FINAL PRESENTASI'	
	%DEFINE NOS_API_VER 1	
...
option_screen:
	...
	mov cx, 10111111b     ; Colour: white text on light green 
	...
	os_init_msg		db 'Yuanda OS', 0
	os_version_msg		db 'Versi ', NOS_VER, 0

	dialog_string_1		db 'Yuanda OS!', 0
	dialog_string_2		db 'pilih interface: OK untuk', 0
	dialog_string_3		db 'program menu, Cancel untuk command line.', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute YuandaOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of YuandaOS, and', 0

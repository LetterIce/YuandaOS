...
help:
  ...
  print "=============================="
  print "YARCHIVE: YUAN ARCHIVING TOOLS"
  print "=============================="
  print "Versi 1 - Beta"
  print "Licenced under the GNU General Public Licence v3"
  print ""
  print "Penggunaan: ARCHIVE (perintah) (nama arsip) [Daftar yang dipisahkan koma]"
  print ""
  print "Perintah:"
  print "    Create - Buat arsip kosong"
  print "    Add - Menambahkan file yang dipilih ke arsip"
  print "    Remove - Hapus file yang dipilih dari arsip"
  print "    Extract - Extract file yang dipilih dari arsip"
  print "    ExtractAll - Extract semua file dari arsip"
  print "    List - List file yang ada di dalam arsip"
  print "    Help - Tampilkan layar bantuan ini"
  print ""
end

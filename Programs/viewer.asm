...
close:
	...
	err_string	db 'Pilih file TXT, BAS atau PCX', 0

	title_msg	db 'YuandaOS File Viewer', 0
	footer_msg	db 'Pilih TXT, BAS or PCX file untuk melihat, atau tekan Esc untuk keluar', 0

	txt_title_msg	db 'YuandaOS Text File Viewer', 0
	txt_footer_msg	db 'gunakan tombol panah untuk scroll dan Q untuk keluar', 0
